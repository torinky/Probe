...
class ServersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'ip' => ['type' => 'text', 'length' => null, 'null' => true, 'default' => null, 'precision' => null, 'comment' => null, 'collate' => null],
        ...
        '_constraints' => [
            ...
            'servers_id_uindex' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
        ],
    ];
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2018-07-15 20:07:11',
                'modified' => '2018-07-15 20:07:11'
            ],
        ];
        parent::init();
    }
